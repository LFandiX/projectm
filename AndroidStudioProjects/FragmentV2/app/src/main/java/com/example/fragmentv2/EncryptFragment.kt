...
//        }
    ...
    override fun onCreateView(
        ...
        val _view = inflater.inflate(R.layout.fragment_encrypt, container, false)

        val teksEncrypt = _view.findViewById<TextView>(R.id.teksEncrypt)
        teksEncrypt.text = message.reversed()
//        val teksEncrypt = EncryptFragmentArgs.fromBundle(requireArguments()).message
