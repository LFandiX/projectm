...
button_times = Button(root, text="*", padx=40, pady=20, command=button_times)
button_devide = Button(root, text="/", padx=40, pady=20, command=button_divide)
...
button_times.grid(row=8, column=1)
button_devide.grid(row=8, column=2)
